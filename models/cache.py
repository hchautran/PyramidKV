...
class PiToMeCache(DynamicCache):
    """
    ...
    def from_legacy_cache(
        ...
        """Converts a cache in the legacy cache format into an equivalent `PiToMeCache`. Used for
